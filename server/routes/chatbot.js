...
router.post('/message/stream', authenticateToken, (req, res, next) => chatbotController.handleStreamMessage(req, res, next));
...
router.post('/feedback',  authenticateToken, (req, res, next) => chatbotController.handleFeedback(req, res, next));
