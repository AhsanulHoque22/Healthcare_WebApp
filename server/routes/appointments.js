...
const createAppointmentValidation = [
  ...
  body('timeBlock').notEmpty().withMessage('Valid time block is required'),
  body('duration').optional().isInt({ min: 1, max: 1440 }).withMessage('Valid duration required'),
  ...
  body('chamber').optional().isString().withMessage('Valid chamber name required')
];
