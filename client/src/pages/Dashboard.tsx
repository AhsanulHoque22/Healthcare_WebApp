  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-8 p-6">
        {/* Modern Header */}
        <div className="relative group overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 p-8 text-white shadow-2xl transition-shadow duration-500 hover:shadow-3xl">
          ...
          <div className={`grid grid-cols-1 gap-6 sm:grid-cols-2 ${statsCards.length === 4 ? 'lg:grid-cols-4' : 'lg:grid-cols-5'}`}>
            {statsCards.map((stat, index) => (
              ...
              >
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-shadow duration-500 border border-white/50 flex flex-col">
        ...
        {/* Recent Appointments */}
          <div className="relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-shadow duration-500 border border-white/50">
              ...
              [...Array(3)].map((_, i) => (
                ...
                recentAppointments.map((appointment: any, index: number) => (
                  ...
                  >
                    ...
                    <div className="relative bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-xl p-4 hover:shadow-lg transition-shadow duration-300 border border-gray-200/50">
                    <div className="flex items-center justify-between">
              ...
              <>
                <div className="relative group mb-4">
                  ...
                  <button
                    ...
                    className="relative group w-full text-left p-6 bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl transition-shadow duration-500 shadow-xl shadow-amber-200/50 border border-amber-400 hover:shadow-2xl hover:shadow-amber-200/60 group-hover:rotate-1"
                  >
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="relative group w-full text-left p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl hover:from-blue-100 hover:to-indigo-100 transition-colors duration-300 border border-blue-200/50 hover:shadow-lg"
                  >
                  <div className="flex items-center">
                      <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center mr-4 transition-transform duration-300">
                        <CalendarIcon className="h-5 w-5 text-white" />
                      </div>
                      <span className="text-blue-800 font-semibold">Book Appointment</span>
                      <ArrowRightIcon className="h-5 w-5 text-blue-400 group-hover:text-blue-600 transition-colors duration-300 ml-auto" />
                  </div>
                  </button>
                </div>
                <div className="relative group">
                  ...
                  <div className="flex items-center">
                      ...
                      <ArrowRightIcon className="h-5 w-5 text-emerald-400 group-hover:text-emerald-600 transition-all duration-300 ml-auto" />
                  </div>
                  </button>
                </div>
              </>
              ...
              <>
                <div className="relative group">
                  ...
                  <div className="flex items-center">
                      ...
                      <ArrowRightIcon className="h-5 w-5 text-blue-400 group-hover:text-blue-600 transition-all duration-300 ml-auto" />
                  </div>
                  </button>
                </div>
                <div className="relative group">
              ...
              <>
                ...
                <div className="relative group">
                  ...
                  <div className="flex items-center">
                      ...
                      <ArrowRightIcon className="h-5 w-5 text-purple-400 group-hover:text-purple-600 transition-all duration-500 ml-auto" />
                  </div>
                  </button>
                </div>
              </>
